...
![](imgs/brian_logo_big.png){.absolute width="10%"}
![](imgs/elephant_logo_sidebar.png){.absolute width="10%" left="3em"}
![](imgs/viziphant_logo_sidebar.png){.absolute width="10%" left="6em"}
![](imgs/syncopy_logo.png){.absolute width="10%" left="9em"}
![](imgs/neurotic-logo-150.png){.absolute width="10%" left="12em"}
![](imgs/pynapple_logo.png){.absolute width="10%" left="15em"}
![](imgs/circus.png){.absolute width="10%" left="18em"}
![](imgs/spikeinterface.png){.absolute width="10%" left="21em"}
![](imgs/suite2p_logo.png){.absolute width="10%" left="24em"}

## Electrophysiology (LFP + M/EEG) + Neuroimaging

![](imgs/mne_logo.png){.absolute width="10%"}
![](imgs/eelbrain.png){.absolute width="10%" left="3em"}
![](imgs/mne_bids.png){.absolute width="10%" left="6em"}
![](imgs/mnelab_logo.png){.absolute width="10%" left="9em"}
![](imgs/mne_nirs_logo_small.png){.absolute width="10%" left="12em"}
![](imgs/mne_realtime.png){.absolute width="10%" left="15em"}
![](imgs/neurokit.png){.absolute width="10%" left="18em"}
![](imgs/dipy-logo.png){.absolute width="10%" left="21em"}

## Machine Learning + Parallelization

![](imgs/nilearn-transparent.png){.absolute width="10%"}
![](imgs/nipype-banner-bg.png){.absolute width="10%" left="3em"}
![](imgs/nitime-banner-bg.png){.absolute width="10%" left="6em"}
![](imgs/pytorch-logo-dark.png){.absolute width="10%" left="9em"}
![](imgs/scikit-learn-logo-small.png){.absolute width="10%" left="12em"}
![](imgs/tensorflow.png){.absolute width="10%" left="15em"}
![](imgs/dask.png){.absolute width="10%" left="18em"}
![](imgs/acme_logo.png){.absolute width="10%" left="21em"}

## Data, Formats, Coding

![](imgs/black.png){.absolute width="10%"}
![](imgs/hdf5.png){.absolute width="10%" left="6em"}
![](imgs/imageio_logo.png){.absolute width="10%" left="9em"}
![](imgs/jupyter.png){.absolute width="10%" left="12em"}
![](imgs/numpy.png){.absolute width="10%" left="15em"}
![](imgs/scipy.png){.absolute width="10%" left="18em"}
![](imgs/matplotlib.png){.absolute width="10%" left="21em"}
![](imgs/seaborn_logo.png){.absolute width="10%" left="24em"}
![](imgs/Rlogo.png){.absolute width="10%" left="27em"}

![](imgs/neologo.png){.absolute width="10%" top="8em"}
![](imgs/nibabel-logo.png){.absolute width="10%" top="8em" left="3em"}
![](imgs/nix_logo.png){.absolute width="10%" top="8em" left="6em"}
![](imgs/pydicom.png){.absolute width="10%" top="8em" left="9em"}
![](imgs/deid.png){.absolute width="10%" top="8em" left="12em"}
![](imgs/pynwb.png){.absolute width="10%" top="8em" left="15em"}
...
https://raw.githubusercontent.com/neuro-conda/neuro-conda/main/libexec/uninstall.sh)"
```
...
(neuro-conda-2023b) ipython
```

```{.shell}
(neuro-conda-2023b) PS C:\Users\myusername >
(neuro-conda-2023b) ipython
```
